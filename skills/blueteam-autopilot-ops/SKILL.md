...
| # | MCP Tool | CLI Script | Alibaba API | Category |
|---|----------|------------|-------------|----------|
| 1 | `ping` | `ping.sh` | `aliyun version` + credential check | Health |
| 2 | `get_account_context` | `get-account-context.sh` | `sas describe-version-config` | Context |
| 3 | `list_security_events` | `list-events.sh` | `sas describe-susp-events` | Events |
| 4 | `get_security_event_detail` | `get-event-detail.sh` | `sas describe-susp-event-detail` | Events |
| 5 | `list_alerts_for_event` | `list-alerts.sh` | `sas describe-susp-event-detail` (extract AlertList) | Events |
| 6 | `list_vulnerabilities` | `list-vulnerabilities.sh` | `sas describe-vul-list` | Vulnerabilities |
| 7 | `get_vulnerability_detail` | `get-vulnerability-detail.sh` | `sas describe-vul-details` | Vulnerabilities |
| 8 | `list_response_policies` | `list-response-policies.sh` | `siem-socket list-automate-response-configs` | Response |
| 9 | `execute_response_policy` | `execute-response-policy.sh` | `siem-socket execute-automate-response` | Response |
| 10 | `get_waf_instance_info` | `get-waf-instance.sh` | `waf-openapi describe-instance` | WAF |
| 11 | `list_waf_security_events` | `list-waf-events.sh` | `sls GetLogs` (WAF logstore) | WAF |
| 12 | `list_waf_top_rules` | `list-waf-top-rules.sh` | `waf-openapi describe-rule-hits-top-rule-id` | WAF |
| 13 | `list_waf_top_ips` | `list-waf-top-ips.sh` | `waf-openapi describe-rule-hits-top-client-ip` | WAF |
| 14 | `list_assets` | `list-assets.sh` | `sas describe-cloud-center-instances` | Assets |
| 15 | `list_knowledge_documents` | `list-knowledge.sh` | Local file discovery (no API) | Knowledge |
| 16 | `get_knowledge_document` | `get-knowledge.sh` | Local file read (no API) | Knowledge |
